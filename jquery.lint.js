...
(function(){
    ...
    var glob = window,
        ...
        langs = {
            ...
            fr: {
                incorrectCall: '%0(%1) a mal été invoqué',
                specialCheckFailed: 'La vérification spéciale de %0(%1) a échoué',
                moreInfo: 'Plus d\'informations:',
                youPassed: 'Vous avez réussi: ',
                collection: 'Collection:',
                availableSigsInclude: 'Signatures disponibles incluses : ',
                errorThrown: 'Lorsque j\'ai appelé %0(%1) avec vos arguments, une erreur est apparue!',
                repeatSelector: "Vous avez utilisé le même sélecteur plus d'une fois.",
                info: 'Information',
                selector: 'Selecteur: ',
                slowSelector: 'Sélecteur: %0\nSelecteurs devraient être aussi précis que possible, ne pas surqualifier et jamais en "classe seulement"',
                selectorAdvice: 'Vous ne devriez utiliser le même sélecteur plus d\'une fois que lorsque vouz savez que la collection renvoyée sera différente. Par exemple, si vous avez ajoutez d\autres éléments à la page qui pourraient correspondre au sélecteur',
                noElementsFound: 'Aucun élément n\'a été trouvé avec le sélecteur : "%0"',
                combineCalls: 'Pourquoi ne pas combiner ces appels en invoquant un objet ? EX: \n%0(%1)',
                methodTwice: "Vous avez invoqué %0(%1) plus d'une fois sur le même objet jQuery",
                triggeredBy: 'Déclanché par l\'évènement %0',
                notBestMethod: 'Plutôt que d\'accéder à la propriété via %0(%1), utilisez %2 à la place',
                event: 'Evènement:',
                handler: 'Gestionnaire:',
                location: 'Position:',
                invalidFilters: 'Selecteur: %0\nVous avez utilisé des filtres invalides (c.a.d. des Pseudo Classes):\n%1',
                badReadyCall: "N'utilisez pas jQuery().ready() - utilisez jQuery(document).ready() à la place. Il est possible que cette version devienne obsolète dans le futur.",
                browser: "N'utilisez pas jQuery.browser",
                browserSafari: "N'utilisez pas jQuery.browser.safari - c'est obsolète. Si vous devez utiliser la détection de navigateur, utilisez jQuery.browser.webkit.",
                featureDetection: 'L\'équipe jQuery mets en garde contre l\'usage de jQuery.browser, utilisez la fonction de détection à la place (voi jQuery.support).',
                boxModel: "N'utilisez pas jQuery.boxModel.",
                boxModelDeprecated: 'Obsolète à partir de jQuery 1.3 (voir jQuery.support)'
            }
        },
